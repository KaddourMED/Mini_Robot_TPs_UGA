...
typedef enum { OK, ERREUR_FICHIER, ERREUR_LECTURE_LARGEUR, ERREUR_LECTURE_HAUTEUR, ERREUR_LARGEUR_INCORRECTE, ERREUR_HAUTEUR_INCORRECTE, ERREUR_CARACTERE_INCORRECT, ERREUR_LIGNE_TROP_LONGUE, ERREUR_LIGNE_TROP_COURTE, ERREUR_LIGNES_MANQUANTES, ERREUR_POSITION_ROBOT_MANQUANTE } erreur_terrain;
