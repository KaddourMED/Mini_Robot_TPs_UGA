...
PROGRAMMES=test_terrain test_robot robot_terrain curiosity curiosity-test curiosity-perf curiosity-obs test_generation_terrains
...
test_terrain.o: test_terrain.c terrain.h generation_terrains.h
...
curiosity-obs.o: curiosity-obs.c environnement.h programme.h \
	interprete.h robot.h terrain.h type_pile.h observateur.h generation_terrains.h

######################################################################
#                       Règles d'édition de liens                    #
######################################################################

test_terrain: test_terrain.o terrain.o generation_terrains.o
	$(CC) $^ -o $@
...
generation_terrains: generation_terrains.o terrain.o
	$(CC) $^ -o $@
